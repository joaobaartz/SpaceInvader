...
class Invader(pygame.sprite.Sprite):
    ...
    def shoot(self):
        ...
        """
        bullet = Bullet(self.rect.midtop, -1, speed = 3, color = RED)
        return bullet
...
class Bullet(pygame.sprite.Sprite):
    ...
    def __init__(self, pos_xy, direction, color = SPRINGREEN, speed = 20):
        """
...
class SpaceInvaders():
    ...
    def __init__(self):
        ...
        background_image = pygame.image.load(DIRECTORY + "/images/planeta.png")
    ...
    def create_invaders(self):
        ...
        for i in range(1, 8):
            enemy_types.append(pygame.image.load(DIRECTORY + ("/images/alien%d.png" % (i % 2))))
